...
, ('Lucy', '30', TRUE, '{"state": "CA", "city": "LA"}', ARRAY['000-0000', '001-1234'])
, ('Green', '35', TRUE, '{"state": "UT", "city": "Salt Lake City"}', ARRAY['987-6666'])
, ('Jhon', 34, FALSE, '{"state": "AZ", "city": "Phoenix", "street": "Main"}', NULL)
